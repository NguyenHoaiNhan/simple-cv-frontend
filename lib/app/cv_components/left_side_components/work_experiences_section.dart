...
class WorkExperiencesSections extends StatefulWidget {
  const WorkExperiencesSections({
    Key? key,
  ...
  @override
  State<WorkExperiencesSections> createState() =>
      _WorkExperiencesSectionsState();
}

class _WorkExperiencesSectionsState extends State<WorkExperiencesSections> {
  late bool showMore;
